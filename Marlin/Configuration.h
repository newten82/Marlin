...
#define DELTA
  ...
  #define DELTA_DIAGONAL_ROD 251.50 // mm

  // Horizontal offset from middle of printer to smooth rod center. lower to bring head down at abc, and up at d
  #define DELTA_SMOOTH_ROD_OFFSET 209.0 // mm
...
#define MANUAL_Z_HOME_POS 271.10 // Distance between the nozzle to printbed after homing
...
#define Y_PROBE_OFFSET_FROM_EXTRUDER 30.0   // Y offset: -front +behind [the nozzle]
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80, 80, 80, 112}  // default steps per unit for Kossel (GT2, 20 tooth)
#define DEFAULT_MAX_FEEDRATE          {500, 500, 500, 25}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {4500,4500,4500,5000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
